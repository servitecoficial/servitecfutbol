...
Rc&&(Qc=Rc?Rc[1]:"");if(Jc){var Sc=Oc();if(null!=Sc&&Sc>parseFloat(Qc)){Pc=String(Sc);break a}}Pc=Qc}var Tc=Pc,Uc;if(z.document&&Jc){var Vc=Oc();Uc=Vc?Vc:parseInt(Tc,10)||void 0}else Uc=void 0;var Wc=Uc;var Xc=Fc()||C("iPod"),Yc=C("iPad");$b();Xb();var Zc=Wb()&&!(Fc()||C("iPad")||C("iPod"));var $c={},ad=null;function bd(a,b){Pa(a);void 0===b&&(b=0);cd();b=$c[b];for(var c=Array(Math.floor(a.length/3)),d=b[64]||"",e=0,f=0;e<a.length-2;e+=3){var g=a[e],h=a[e+1],k=a[e+2],m=b[g>>2];g=b[(g&3)<<4|h>>4];h=b[(h&15)<<2|k>>6];k=b[k&63];c[f++]=""+m+g+h+k}m=0;k=d;switch(a.length-e){case 2:m=a[e+1],k=b[(m&15)<<2]||d;case 1:a=a[e],c[f]=""+b[a>>2]+b[(a&3)<<4|m>>4]+k+d}return c.join("")}
...
function Xd(a,b,c,d,e){e=void 0===e?!0:e;a.h||(a.h={});var f=a.h[c],g=Sd(a,c,3,d),h=xd(a.u);if(f)h||(Object.isFrozen(f)?e||(f=Array.prototype.slice.call(f),a.h[c]=f):e&&Object.freeze(f));else{f=[];var k=!!(td(a.u)&16),m=xd(g);!h&&m&&(g=vd(Array.prototype.slice.call(g)),D(a,c,g,d));d=m;for(var q=0;q<g.length;q++){var r=g[q];d=d||xd(r);var w=b,t=k,y=!1;y=void 0===y?!1:y;t=void 0===t?!1:t;r=Array.isArray(r)?new w(t?yd(r):r):y?new w:void 0;void 0!==r&&(f.push(r),m&&rd(r.u,2))}a.h[c]=f;a=g;b=!d;Object.isFrozen(a)||
(c=td(a)|33,ud(a,b?c|8:c&-9));(h||e&&m)&&rd(f,2);(h||e)&&Object.freeze(f)}return f}
...
;function I(a,b,c){null==a&&(a=he);he=null;var d=this.constructor.h||0,e=0<d,f=this.constructor.i,g=!1;if(null==a){var h=f?[f]:[];rd(h,48);a=h;h=!0}else{if(!Array.isArray(a))throw Error();if(f&&f!==a[0])throw Error();if(h=!!(td(a)&16))g=td(a),ud(a,g|32),g=!!(g&32)}e&&0<a.length&&Cd(a[a.length-1])&&"g"in a[a.length-1]&&(d=0);this.la=(f?0:-1)-d;this.h=void 0;this.u=a;a:{f=this.u.length;d=f-1;if(f&&(f=this.u[d],Cd(f))){this.R=f;b=Object.keys(f);0<b.length&&jb(b,isNaN)?this.qa=Number.MAX_VALUE:this.qa=
d-this.la;break a}void 0!==b&&-1<b?(this.qa=Math.max(b,d+1-this.la),this.R=void 0):this.qa=Number.MAX_VALUE}if(!e&&this.R&&"g"in this.R)throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');if(c)for(e=h&&!g?wd:vd,b=0;b<c.length;b++)h=c[b],(g=Rd(this,h))?Array.isArray(g)&&e(g):D(this,h,Hd,!1,!0)}
...
ue.prototype.preventDefault=function(){this.defaultPrevented=!0};function ve(a){var b=B("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||z.$googDebugFname||b}catch(g){e="Not available",c=!0}b=we(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
e=z.FormData&&a instanceof z.FormData;!(0<=eb(Ng,b))||d||e||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");b=p(c);for(d=b.next();!d.done;d=b.next())c=p(d.value),d=c.next().value,c=c.next().value,this.v.setRequestHeader(d,c);this.da&&(this.v.responseType=this.da);"withCredentials"in this.v&&this.v.withCredentials!==this.X&&(this.v.withCredentials=this.X);try{Rg(this),0<this.o&&(this.W=Sg(this.v),this.getStatus(),this.W?(this.v.timeout=this.o,this.v.ontimeout=Xa(this.wc,this)):
this.F=Rf(this.wc,this.o,this)),this.getStatus(),this.s=!0,this.v.send(a),this.s=!1}catch(g){this.getStatus(),Qg(this,g)}};
...
u(ih,I);var jh;jh=new function(a,b,c){this.i=a;this.fieldName=b;this.h=c;this.isRepeated=0;this.j=le}(175237375,{tr:0},ih);function kh(a,b,c,d,e,f,g,h,k,m,q){bf.call(this);var r=this;this.O="";this.j=[];this.Ob="";this.Pb=this.va=-1;this.Xa=!1;this.I=this.m=null;this.F=0;this.Ec=1;this.timeoutMillis=0;this.da=!1;bf.call(this);this.Ya=b||function(){};
...
kh.prototype.flush=function(a,b){var c=this;if(0===this.j.length)a&&a();else if(this.da)rh(this);else{var d=Date.now();if(this.Pb>d&&this.va<d)b&&b("throttled");else{var e=sh(this.s,this.j,this.F);d={};var f=this.Ya();f&&(d.Authorization=f);var g=oh(this);this.K&&(d["X-Goog-AuthUser"]=this.K,g=zc(g,"authuser",this.K));this.pageId&&(d["X-Goog-PageId"]=this.pageId,g=zc(g,"pageId",this.pageId));if(f&&this.Ob===f)b&&b("stale-auth-token");else{this.j=[];this.i.enabled&&this.i.stop();this.F=0;var h=ie(e),
k;this.I&&this.I.isSupported(h.length)&&(k=this.I.compress(h));var m={url:g,body:h,Kc:1,Gb:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(t){c.o.reset();Qf(c.i,c.o.getValue());if(t){var y=null;try{var E=JSON.parse(t.replace(")]}'\n",""));y=new gh(E)}catch(F){}y&&(t=Number(ce(Rd(y,1),"-1")),0<t&&(c.va=Date.now(),c.Pb=c.va+t),y=jh.j(y))&&(y=ce(Rd(y,1),-1),-1!=y&&(c.Xa||ph(c,y)))}a&&a()},r=function(t,y){var E=Yd(e,ch,3),F=c.o;
F.h=Math.min(3E5,2*F.h);F.i=Math.min(3E5,F.h+Math.round(.2*(Math.random()-.5)*F.h));Qf(c.i,c.o.getValue());401===t&&f&&(c.Ob=f);void 0===y&&(y=500<=t&&600>t||401===t||0===t);y&&(c.j=E.concat(c.j),c.W||c.i.enabled||c.i.start());b&&b("net-send-failed",t)},w=function(){c.Wa?c.Wa.send(m,q,r):c.Cc(m,q,r)};
...
;function Ch(a){var b=this;this.i=!1;var c=a.program;var d=a.Vc;if(a.jd){var e;this.wa=null!=(e=a.wa)?e:new zh(d)}var f=new Bh;this.j=f.promise;this.l=p((0,z[d].a)(c,function(g,h){Promise.resolve().then(function(){var k;if(null!=(k=b.wa)){var m=Ah()-k.o;k.m.h.pb("/client_streamz/bg/fil",m,k.Ea)}f.resolve({Ic:g,wd:h})})},!0)).next().value;
this.vd=f.promise.then(function(){})}
Ch.prototype.snapshot=function(a){var b=this;if(this.i)throw Error("Already disposed");var c=Ah(),d;null!=(d=this.wa)&&d.i.h.Lb("/client_streamz/bg/fsc",d.Ea);return this.j.then(function(e){var f=e.Ic;return new Promise(function(g){f(function(h){var k;if(null!=(k=b.wa)){var m=Ah()-c;k.j.h.pb("/client_streamz/bg/fsl",m,k.Ea)}g(h)},[a.Vb,
a.xd])})})};
...
function Wm(a,b){b=void 0===b?{}:b;var c,d,e,f;return x(function(g){if(1==g.h)return ya(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.Jc)&&c.addEventListener("blocked",function(){e()}),v(g,Bm(c),4);
...
function Ln(a){var b=new Yi,c=new Ri;D(c,1,a.fc);D(c,2,a.ec);D(c,16,a.Wc);D(c,17,a.innertubeContextClientVersion);if(a.yb){var d=a.yb,e=new Ni;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);G(c,Ni,62,e)}(d=z.devicePixelRatio)&&1!=d&&D(c,65,d);d=Fk();""!==d&&D(c,54,d);d=Gk();if(0<d.length){e=new Ti;for(var f=0;f<d.length;f++){var g=new Li;D(g,1,d[f].key);Td(g,2,Mi,d[f].value);ae(e,15,Li,g)}G(b,
...
b.options.onError=function(e,f){var g,h,k;return x(function(m){switch(m.h){case 1:g=bo(f);if(!(a.J&&a.J("nwl_consider_error_code")&&g||a.J&&!a.J("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.kb)){m.A(2);break}if(!a.L.nb){m.A(3);break}return v(m,a.L.nb(),3);case 3:if(a.L.V()){m.A(2);break}c(e,f);if(!a.J||!a.J("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.A(6);break}return v(m,a.N.Hb(b.id,a.H,!1),6);case 6:return m.return();case 2:if(a.J&&a.J("nwl_consider_error_code")&&
...
;var Bo={},Co=Bn("ServiceWorkerLogsDatabase",{Na:(Bo.SWHealthLog={rb:1},Bo),Jb:!0,upgrade:function(a,b){b(1)&&Hm(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
...
l.nb=function(a){a=Uh(this.i,a);a.then(function(b){M("use_cfr_monitor")&&Ko().requestComplete("generate_204",b)});
return a};
...
c.onFetchSuccess=function(N,Q){Rn(E);O(N,Q)}}try{y&&d.retry&&!d.ic.bypassNetworkless?(g.method="POST",d.ic.writeThenSend?Wo().writeThenSend(t,g):Wo().sendAndWrite(t,g)):M("web_all_payloads_via_jspb")?jl(t,g):(g.method="POST",g.postParams||(g.postParams={}),jl(t,g))}catch(N){if("InvalidAccessError"==N.name)E&&(Rn(E),E=0),Lk(Error("An extension is blocking network request."));
...
function $p(a){var b=void 0===a?{}:a;a=void 0===b.gd?!1:b.gd;b=void 0===b.Qc?!0:b.Qc;if(null==B("_lact",window)){var c=parseInt(L("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;A("_lact",c,window);A("_fact",c,window);-1==c&&aq();Vp(document,"keydown",aq);Vp(document,"keyup",aq);Vp(document,"mousedown",aq);Vp(document,"mouseup",aq);a?Vp(window,"touchmove",function(){bq("touchmove",200)},{passive:!0}):(Vp(window,"resize",function(){bq("resize",200)}),b&&Vp(window,"scroll",function(){bq("scroll",200)}));
...
function Qq(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(R()),g=a.size,h=new Map([].concat(ia(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new pk;var r=Ln(b.config_||En());G(k,Yi,1,r);q=q?Wq(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())ae(k,3,jk,r.value);(q=Cq[m])&&Xq(k,m,q);delete Cq[m];m="visitorOnlyApprovedKey"===m;Yq(k,f,m);Uq(d);k=ie(k);m=Vq(d,m,function(){g--;g||c()},function(){g--;
g||c()},e);
...
jb:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var rr={oa:[],ma:[{callback:qr,weight:500}]};function qr(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
":"+la);if("IGNORED"===a.level)var fa=0;else a:{for(var xe=ur(),ye=p(xe.oa),nd=ye.next();!nd.done;nd=ye.next()){var pa=nd.value;if(H.message&&H.message.match(pa.xr)){fa=pa.weight;break a}}for(var bp=p(xe.ma),Oj=bp.next();!Oj.done;Oj=bp.next()){var cp=Oj.value;if(cp.callback(H)){fa=cp.weight;break a}}fa=1}H.sampleWeight=fa;for(var dp=p(pr),Pj=dp.next();!Pj.done;Pj=dp.next()){var Qj=Pj.value;if(Qj.jb[H.name])for(var ep=p(Qj.jb[H.name]),Rj=ep.next();!Rj.done;Rj=ep.next()){var fp=Rj.value,Ig=H.message.match(fp.regexp);
if(Ig){H.params["params.error.original"]=Ig[0];for(var Sj=fp.groups,gp={},od=0;od<Sj.length;od++)gp[Sj[od]]=Ig[od+1],H.params["params.error."+Sj[od]]=Ig[od+1];H.message=Qj.Bb(gp);break}}}H.params||(H.params={});var hp=ur();H.params["params.errorServiceSignature"]="msg="+hp.oa.length+"&cb="+hp.ma.length;H.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Br.has(H.message)){if("ERROR"===h){vr.ta("handleError",H);if(M("record_app_crashed_web")&&0===Er&&1===H.sampleWeight)if(Er++,M("errors_via_jspb")){var Tj=new rj;D(Tj,1,1);if(!M("report_client_error_with_app_crash_ks")){var ip=new mj;D(ip,1,H.message);var jp=new nj;G(jp,mj,3,ip);var kp=new oj;G(kp,nj,5,jp);var lp=new pj;G(lp,oj,9,kp);G(Tj,pj,4,lp)}var mp=new jk;Zd(mp,rj,20,
kk,Tj);hr(mp)}else{var np={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(np.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});cm("appCrashed",np)}Dr++}else"WARNING"===h&&vr.ta("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var ze=h;if(M("errors_via_jspb")){if(Jr())var pp=void 0;else{var pd=new jj;D(pd,1,H.stack);H.fileName&&D(pd,4,H.fileName);var Gb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Gb.length&&(1!==
...
if(!Ck()&&Wj)for(var rp=p(Object.keys(Wj)),xc=rp.next();!xc.done;xc=rp.next()){var sp=xc.value,Xj=new ij;D(Xj,1,sp);D(Xj,2,String(Wj[sp]));ae(Yb,4,ij,Xj)}var Yj=H.params;if(Yj){var tp=p(Object.keys(Yj));for(xc=tp.next();!xc.done;xc=tp.next()){var up=xc.value,Zj=new ij;D(Zj,1,"client."+up);D(Zj,2,String(Yj[up]));ae(Yb,4,ij,Zj)}}var vp=L("SERVER_NAME"),wp=L("SERVER_VERSION");if(vp&&wp){var ak=new ij;D(ak,1,"server.name");D(ak,2,vp);ae(Yb,4,ij,ak);var bk=new ij;D(bk,1,"server.version");D(bk,2,wp);ae(Yb,
4,ij,bk)}var Jg=new nj;G(Jg,gj,1,Yb);G(Jg,kj,2,Uj);G(Jg,mj,3,wc);pp=Jg}var xp=pp;if(!xp)break a;var yp=new jk;Zd(yp,nj,163,kk,xp);hr(yp)}else{if(Jr())var zp=void 0;else{var Ae={stackTrace:H.stack};H.fileName&&(Ae.filename=H.fileName);var Hb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Hb.length&&(1!==Hb.length||isNaN(Number(Hb[0]))?2!==Hb.length||isNaN(Number(Hb[0]))||isNaN(Number(Hb[1]))||(Ae.lineNumber=Number(Hb[0]),Ae.columnNumber=Number(Hb[1])):Ae.lineNumber=Number(Hb[0]));
var ck={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===ze?ck.level="ERROR_LEVEL_ERROR":"WARNING"===ze&&(ck.level="ERROR_LEVEL_WARNNING");var Fv={isObfuscated:!0,browserStackInfo:Ae},qd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(qd.experimentIds=L("FEXP_EXPERIMENTS"));var dk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Ck()&&dk)for(var Ap=p(Object.keys(dk)),yc=Ap.next();!yc.done;yc=Ap.next()){var Bp=yc.value;qd.kvPairs.push({key:Bp,
value:String(dk[Bp])})}var ek=H.params;if(ek){var Cp=p(Object.keys(ek));for(yc=Cp.next();!yc.done;yc=Cp.next()){var Dp=yc.value;qd.kvPairs.push({key:"client."+Dp,value:String(ek[Dp])})}}var Ep=L("SERVER_NAME"),Fp=L("SERVER_VERSION");Ep&&Fp&&(qd.kvPairs.push({key:"server.name",value:Ep}),qd.kvPairs.push({key:"server.version",value:Fp}));zp={errorMetadata:qd,stackTrace:Fv,logMessage:ck}}var Gp=zp;if(!Gp)break a;cm("clientError",Gp)}if("ERROR"===ze||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
...
;var fs={ue:3611,Fd:27686,Gd:85013,Hd:23462,Jd:157557,Kd:42016,Ld:62407,Md:26926,Id:43781,Nd:51236,Od:79148,Pd:50160,Qd:77504,ce:153587,de:87907,ee:18630,ge:54445,he:80935,ie:152172,je:105675,ke:150723,le:37521,me:147285,ne:47786,oe:98349,pe:123695,qe:6827,re:29434,se:7282,te:124448,ye:32276,xe:76278,ze:147868,Ae:147869,Be:93911,Ce:106531,De:27259,Ee:27262,Fe:27263,He:21759,Ie:27107,Je:62936,Ke:160866,Le:49568,Me:160789,Ne:38408,Oe:80637,Pe:68727,Qe:68728,Re:80353,Se:80356,Te:74610,Ue:45707,Ve:83962,
...
nq:18635,oq:39305,pq:18046,qq:53969,rq:8213,sq:93926,tq:102852,uq:110099,wq:22678,xq:69076,yq:137575,Aq:139224,Bq:100856,Cq:154430,Dq:17736,Eq:3832,Fq:147111,Gq:55759,Hq:64031,Nq:93044,Oq:93045,Pq:34388,Qq:17657,Rq:17655,Sq:39579,Tq:39578,Uq:77448,Vq:8196,Wq:11357,Xq:69877,Yq:8197,Zq:156512,br:161613,dr:156509,er:161612,fr:161614,gr:82039};function gs(){var a=vb(hs),b;return(new yf(function(c,d){a.onSuccess=function(e){cl(e)?c(new is(e)):d(new js("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
b=jl("//googleads.g.doubleclick.net/pagead/id",a)})).ob(function(c){c instanceof Ff&&b.abort();
return Df(c)})}
...
function Nk(){var a=us();if(void 0!==a)return Df(a);ts||(ts=gs().then(vs).ob(function(b){return ws(2,b)}));
return ts}
...
D(b,13,W[Mt(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=$r())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=cu();1!==a&&-1!==a||D(b,6,!0);a=ut();D(b,3,"cold");du(a);a=eu();if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Hj,D(d,1,c),ae(b,83,Hj,d);bu(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&fu(b,a[b]);b={isNavigation:!0,actionType:Mt(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=Mt(a);if(a=L("CLIENT_PROTOCOL"))b.httpProtocol=
...
aa:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(rb(g)||!g.trackingParams&&!g.veType)&&Ir(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new zj;h.i(b);Bj(h,c.getAsJspb());hb(e,function(k){k=k.getAsJspb();ae(h,3,tj,k)});
...
function Hv(a,b,c,d){a.state=5;try{var e=new Ch({program:b,Vc:c,jd:M("att_web_record_metrics")});e.vd.then(function(){a.state=6;d&&d(b)});
...
;function Nv(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?Pl():d;this.l=c;this.j=d;this.i=new Bh;this.h=a;a={};c=p(this.h.entries());for(d=c.next();!d.done;a={Ga:a.Ga,Ra:a.Ra},d=c.next()){var e=p(d.value);d=e.next().value;e=e.next().value;a.Ra=d;a.Ga=e;d=function(f){return function(){f.Ga.Ab();b.h[f.Ra].lb=!0;b.h.every(function(g){return!0===g.lb})&&b.i.resolve()}}(a);
e=Ll(d,Ov(this,a.Ga));this.h[a.Ra]=Object.assign({},a.Ga,{Ab:d,jobId:e})}}
function Pv(a){var b=Array.from(a.h.keys()).sort(function(d,e){return Ov(a,a.h[e])-Ov(a,a.h[d])});
...
Qv.prototype.transition=function(a,b){var c=this,d=this.B.find(function(f){return Array.isArray(f.from)?f.from.find(function(g){return g===c.state&&f.D===a}):f.from===c.state&&f.D===a});
if(d){this.j&&(Pv(this.j),this.j=void 0);this.state=a;d=d.action.bind(this);var e=this.plugins.filter(function(f){return f[a]}).map(function(f){return f[a]});
d(Rv(this,e,this.o),b)}else throw Error("no transition specified from "+this.state+" to "+a);};
function Rv(a,b,c){return function(){var d=Ja.apply(0,arguments),e=b.filter(function(k){var m;return 10===(null!=(m=null!=c?c:k.priority)?m:0)}),f=b.filter(function(k){var m;
...
A("ytglobal.storageClass_",Xv);function am(a,b){var c=this;this.handleError=a;this.h=b;this.i=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.i=!0});
...
;function kw(a){bw.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.sd.bind(this));this.addEventListener("onVolumeChange",this.td.bind(this));this.addEventListener("onApiChange",this.nd.bind(this));this.addEventListener("onPlaybackQualityChange",this.pd.bind(this));this.addEventListener("onPlaybackRateChange",this.qd.bind(this));this.addEventListener("onStateChange",this.rd.bind(this));this.addEventListener("onWebglSettingsChanged",
this.ud.bind(this))}
u(kw,bw);l=kw.prototype;
l.Nb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&hw(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=iw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
...
function xw(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
...
function Ew(a){if(!a.h()&&!a.O){var b=Iw(a);if(b&&"html5"===(Jw(a)?"html5":null))a.P="html5",a.isReady()||Lw(a);else if(Mw(a),a.P="html5",b&&a.l&&a.m)a.m.appendChild(a.l),Lw(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.F=function(){c=!0;var d=Nw(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?Gw(a.config):void 0;d&&d(a.m,e,a.webPlayerContextConfig,a.Wa);Lw(a)};
...
function Bw(a){a.da=!1;if(a.W)for(var b in a.i)a.i.hasOwnProperty(b)&&a.W(b,a.i[b]);for(var c in a.I)a.I.hasOwnProperty(c)&&window.clearTimeout(Number(c));a.I={};a.o=null;a.W=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Cw(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){kq("WATCH_LATER_VIDEO_ADDED",b)});
...
function Hw(a,b){var c=b;if("string"===typeof b){if(a.ka[b])return a.ka[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(z,d)}catch(f){Hr(f)}};
a.ka[b]=c}return c?c:null}
function Sw(a,b){var c="ytPlayer"+b+a.s;a.i[b]=c;z[c]=function(d){var e=dl(function(){if(!a.h()){try{a.K.ta(b,null!=d?d:void 0)}catch(h){Ir(new P("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.s,data:d}))}var f=a.I,g=String(e);g in f&&delete f[g]}},0);
sb(a.I,String(e))};
return c}
...
;var Tw={},Uw="player_uid_"+(1E9*Math.random()>>>0);function Vw(a,b){var c="player",d=!1;d=void 0===d?!0:d;c="string"===typeof c?kf(c):c;var e=Uw+"_"+Ra(c),f=Tw[e];if(f&&d)return Ww(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Aw(c,e,a,b,void 0);Tw[e]=f;kq("player-added",f.api);te(f,function(){delete Tw[f.getId()]});
return f.api}
...
;function ex(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=L("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=L("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=oc(window.location.href);g&&f.push(g);g=oc(d);if(0<=eb(f,g)||!g&&0==d.lastIndexOf("/",0))if(M("autoescape_tempdata_url")&&(f=document.createElement("a"),fc(f,d),d=f.href),d&&(d=pc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:$r()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
dx(d,b,h)}else dx(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var r=void 0===r?Ph:r;a:{r=void 0===r?Ph:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Nh&&m.bd(a)){r=new Ob(a,Pb);break a}r=void 0}r=r||Sb;if(r instanceof Ob)var w=Qb(r);else{b:if(Fh){try{w=new URL(r)}catch(t){w="https:";break b}w=w.protocol}else c:{w=document.createElement("a");try{w.href=r}catch(t){w=void 0;break c}w=
...
d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Xw=Vw(a,c);Xw.addEventListener("onVideoDataChange",$w);Xw.addEventListener("onReady",bx);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?Zw=new kw(Xw):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Yw=new rw(window.parent,a,b),Zw=new ow(Xw,Yw.connection));Bv();M("ytidb_create_logger_embed_killswitch")||M("embeds_web_disable_nwl")||$l();a={};Wv||(Wv=new Vv);Wv.install((a.flush_logs={callback:function(){Lq()}},
a));
M("embeds_web_disable_nwl")||ap();M("ytidb_clear_embedded_player")&&Xh.U(function(){var e;if(!Ju){var f=Us(),g={Fb:Iu,xc:Hu};f.h.set(g.Fb,g);g={Ub:{feedbackEndpoint:Vs(Du),modifyChannelNotificationPreferenceEndpoint:Vs(Eu),playlistEditEndpoint:Vs(Fu),subscribeEndpoint:Vs(Bu),unsubscribeEndpoint:Vs(Cu),webPlayerShareEntityServiceEndpoint:Vs(Gu)}};var h=Is.getInstance(),k={};h&&(k.client_location=h);if(void 0===m){As.h||(As.h=new As);var m=As.h}void 0===e&&(e=f.resolve(Iu));ou(g,e,m,k);m={Fb:uu,yc:nu.h};
f.h.set(m.Fb,m);Ju=f.resolve(uu)}lv()})});
var fx=Jk(function(a){if(!a.persisted){hu();a=xl.getInstance();var b=Al(119),c=1<window.devicePixelRatio;if(document.body&&gi(document.body,"exp-invert-logo"))if(c&&!gi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!gi(d,"inverted-hdpi")){var e=ei(d);fi(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&gi(document.body,"inverted-hdpi")&&hi();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Bl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete wl[b]:
(c=d.toString(16),wl[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in wl)d.push(f+"="+encodeURIComponent(String(wl[f])));tl(b,d.join("&"),63072E3,a.i,c)}Vu.h||(Vu.h=new Vu);f=Vu.h;a=16623;var g=void 0===g?{}:g;Object.values(fs).includes(a)||(Ir(new P("createClientScreen() called with a non-page VE",a)),a=83769);g.isHistoryNavigation||f.h.push({rootVe:a,key:g.key||""});f.o=[];f.M=[];g.Xb?Yu(f,a,g):Zu(f,a,g)}}),gx=Jk(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?
cx():a.persisted||cx()}),hx=Jk(cx);
...
A("yt.player.exports.navigate",B("yt.player.exports.navigate")||ex);A("yt.util.activity.init",B("yt.util.activity.init")||$p);A("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||cq);A("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||aq);}).call(this);
